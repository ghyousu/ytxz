...
$(document).ready(function(){
   ...
   <?php
      // populate each item in the play list
      $videoDirLinux = dirname($_SERVER["SCRIPT_FILENAME"]);
      $videoDirWeb   = dirname($_SERVER["SCRIPT_NAME"]);
      $m4aFiles = glob( $videoDirLinux . "/*.m4a" );
      sort( $m4aFiles );
      foreach ( $m4aFiles as $file )
      {
         $file = basename($file);
         print '{ title: "' . $file . '", m4v: "' . $videoDirWeb . '/' . $file . '" },' . "\n";
      }
   ?>
	], {
